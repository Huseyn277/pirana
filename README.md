...
---
Sistemi SQL injection hucumundan qorumaq ucun bu kodu "check_login.php" faylina elave etmeliyik. Bunun üçün *Prepared Statements* (Hazır qəliblər) istifadə olunur.
*Düzgün variant (PDO ilə):*
```php
...
$user = $stmt->fetch();
```
Bu üsulda istifadəçi nə yazırsa yazsın, baza onu bir *komanda* kimi deyil, sadəcə adi bir *yazı (tekst)* kimi qəbul edir. Beləliklə, hackerin yazdığı kodlar "zərərsizləşir".
